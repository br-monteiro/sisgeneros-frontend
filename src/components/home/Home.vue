<template>
  <div>
    <template-default pgtitle="Home">
      <loaging-bar v-show="progress"></loaging-bar>
            ...
            <div class="row">
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Itens<small>mais solicitados</small></h2>
      ...
      <box-content class="col-md-6 col-sm-12 col-xs-12" boxtitle="Lista de Solicitações">
                          <div class="x_content">
      ...
      <box-content class="col-md-6 col-sm-12 col-xs-12" boxtitle="Itens com Estoque Baixo">
                          <div class="x_content">
                    <article class="media event">
                      <a class="pull-left date">
                        <p class="month">April</p>
